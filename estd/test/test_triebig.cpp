...
#ifndef DISABLE_TEST_TRIEBIG_HPP
...
using TrieBigT = estd::Trie<std::string,estd::TrieBigNode<char,Empty,AlphaHash>>;


TEST(TRIEBIG, TrieContains)
{
	TrieBigT t;
...
#endif // DISABLE_TEST_TRIEBIG_HPP
