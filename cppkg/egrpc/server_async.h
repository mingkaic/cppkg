...
#ifndef CPPKG_EGRPC_SERVER_ASYNC_H
#define CPPKG_EGRPC_SERVER_ASYNC_H
...
struct AsyncServerCall final : public iServerCall
{
	...
	AsyncServerCall (std::shared_ptr<cisab::logs::iLogger> logger,
...
#endif // CPPKG_EGRPC_SERVER_ASYNC_H
