...
#include "cppkg/jobs/managed_job.h"
#include "cppkg/jobs/scope_guard.h"
#include "cppkg/jobs/sequence.h"
...
TEST(JOBS, ScopeGuardsMove)
{
	size_t execution = 0;
	{
		...
		{
			ScopeGuard steal(std::move(defer));
			EXPECT_EQ(0, execution);
		}
